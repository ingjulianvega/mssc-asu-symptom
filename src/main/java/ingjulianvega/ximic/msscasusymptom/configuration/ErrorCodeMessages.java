...
public class ErrorCodeMessages {
    ...
    public static final String SYMPTOM_NOT_FOUND_API_CODE = "401";
    public static final String SYMPTOM_NOT_FOUND_ERROR = "SYMPTOM_NOT_FOUND";
    public static final String SYMPTOM_NOT_FOUND_MESSAGE = "No se encontró el síntoma";
    public static final String SYMPTOM_NOT_FOUND_SOLUTION = "Verifique los datos";
